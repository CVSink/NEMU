...
* NEMU-PAL
## NEMU
NEMU(NJU Emulator) is a simple but complete full-system x86 emulator. It is the main part of this programming assignment. Small x86 programs can run under NEMU. The main features of NEMU include
